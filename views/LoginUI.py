...
class Ui_LoginDialog(object):
    def setupUi(self, LoginDialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icon/icon/login-24.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icon/icon/150_-_Cancel-20.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, LoginDialog):
        ...
        LoginDialog.setWindowTitle(_translate("LoginDialog", "VCenter Monitor"))
